...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO Users(username, email, password) VALUES('taekho', 'taekho1225@gmail.com', 'taekho');";
  ...
  */
  public static final String PART2_10 = "INSERT INTO Posts(title, content, user_id) Values('제목', '내용', 1);";
  ...
  */
  public static final String PART2_12 = "SELECT p.title FROM users u JOIN Posts p ON u.user_id = p.user_id WHERE u.user_id = 1;";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-13. users 테이블의 user_id가 1인 유저가 작성한 post의 board name을 찾기위한 SQL을 작성해주세요.
  */
  public static final String PART2_13 = "SELECT b.name FROM users u JOIN posts p ON u.user_id = p.user_id JOIN Boards b On p.board_id = b.board_id WHERE u.user_id = 1;";
  ...
  */
  public static final String PART2_15 = "SELECT COUNT(c.comment_id) AS CommentCount FROM Comments c JOIN Users u ON c.user_id = u.user_id WHERE u.username = 'luckykim' GROUP BY c.user_id;";
  ...
  */
  public static final String PART2_16 = "SELECT u.username as username, COUNT(c.comment_id) AS CommentCount FROM Comments c " +
  ...
  */
  public static final String PART2_17 = "SELECT b.name, COUNT(p.post_id) FROM Boards b " +
          "LEFT JOIN Posts p ON b.board_id = p.board_id " +
          "GROUP BY b.board_id;";
  ...
  */
  public static final String PART2_18 = "SELECT b.name, AVG(p.content) AS AvgLength FROM Boards b " +
          "LEFT JOIN Posts p ON b.board_id = p.board_id " +
          "GROUP BY b.board_id;";
  ...
  */
  public static final String PART2_20 = "SELECT t.name, COUNT(p.post_id) AS PostCount FROM Tags t " +
          "LEFT JOIN Post_Tags p ON t.tag_id = p.tag_id " +
          "GROUP BY t.name;";
}
